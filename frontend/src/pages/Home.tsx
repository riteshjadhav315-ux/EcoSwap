              ...
              <div className="mt-16 flex flex-col items-center gap-6">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-3 rounded-2xl border border-emerald-100 text-emerald-600 hover:bg-emerald-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                ...
                <p className="text-emerald-800/50 text-sm font-medium">
                  Showing page <span className="text-emerald-600">{currentPage}</span> of <span className="text-emerald-600">{totalPages}</span>
                </p>
              </div>
            )}
          </>
